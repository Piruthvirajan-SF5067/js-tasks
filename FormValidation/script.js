...
validateName = () => {
  ...
  if (regexName.test(nameValue)) {
    ...
    nameError.innerHTML = "Name is requirred";
    return false;
  } else {
    nameError.innerHTML = "Numeric and Special characters not allowed";
    return false;
  }
};
...
validateFatherName = () => {
  ...
  if (regexName.test(fatherNameValue)) {
    ...
    fatherNameError.innerHTML = "Name is requirred";
    return false;
  } else {
    fatherNameError.innerHTML = "Numeric and Specialcharacters not allowed";
    return false;
  }
};
...
validateEmail = () => {
  ...
  if (email_id === "") {
    emailError.innerHTML = "Email is requirred";
    return false;
...
validateDOB = () => {
  ...
  if (dobValue === "") {
    dobError.innerHTML = "DOB is requirred";
    return false;
  } else {
    dobError.innerHTML = "";
    return true;
...
validatePhone = () => {
  ...
  if (phoneValue === "") {
    mobileError.innerHTML = "PhoneNumber is requirred";
    return false;
...
validateAddress = () => {
  ...
  if (addressValue === "") {
    addressError.innerHTML = "Address is requirred";
    return false;
  } else {
...
validateAddress2 = () => {
  ...
  if (address2Value === "") {
    address2Error.innerHTML = "Address is requirred";
    return false;
  } else {
...
validateCity1 = () => {
  ...
  if (regexName.test(city1Value)) {
    ...
    cityError.innerHTML = "City Name is requirred";
    return false;
  } else {
    cityError.innerHTML = "Numeric and Specialcharacters not allowed";
    return false;
  }
};
...
validateCity2 = () => {
  ...
  if (regexName.test(city2Value)) {
    ...
    city2Error.innerHTML = "City Name is requirred";
    return false;
  } else {
    city2Error.innerHTML = "Numeric and Specialcharacters not allowed";
    return false;
  }
};
...
validatePincode2 = () => {
  ...
  if (pincode2 === "") {
    ...
    pincode2Error.innerHTML = "Please enter your valid permanent pincode";
    return false;
  } else {
    pincode2Error.innerHTML = "";
    return true;
  }
};
...
validatestate2 = () => {
  ...
  if (state2value === "") {
    stat2Error.textContent = "Please select your state";
    return false;
  } else {
    stat2Error.textContent = "";
    return true;
  }
};
